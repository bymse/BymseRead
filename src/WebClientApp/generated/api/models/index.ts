 ...
 */
// @ts-ignore
export function createBookCollectionItemFromDiscriminatorValue(
  parseNode: ParseNode | undefined,
): (instance?: Parsable) => Record<string, (node: ParseNode) => void> {
 ...
 */
// @ts-ignore
export function deserializeIntoBookCollectionItem(
  bookCollectionItem: Partial<BookCollectionItem> | undefined = {},
): Record<string, (node: ParseNode) => void> {
  return {
    bookId: n => {
      bookCollectionItem.bookId = n.getGuidValue()
    },
    coverUrl: n => {
      bookCollectionItem.coverUrl = n.getStringValue()
    },
    currentPage: n => {
      bookCollectionItem.currentPage = n.getNumberValue()
    },
    fileUrl: n => {
      bookCollectionItem.fileUrl = n.getStringValue()
    },
    lastBookmark: n => {
      bookCollectionItem.lastBookmark = n.getObjectValue<BookmarkInfo>(createBookmarkInfoFromDiscriminatorValue)
    },
    pages: n => {
      bookCollectionItem.pages = n.getNumberValue()
    },
    title: n => {
      bookCollectionItem.title = n.getStringValue()
    },
  }
}
/**
...
export function deserializeIntoBookInfo(
  ...
  return {
    ...
    status: n => {
      bookInfo.status = n.getEnumValue<BookStatus>(BookStatusObject)
    },
    title: n => {
...
export function deserializeIntoBooksCollectionInfo(
  ...
  return {
    activeBooks: n => {
      booksCollectionInfo.activeBooks = n.getCollectionOfObjectValues<BookCollectionItem>(
        createBookCollectionItemFromDiscriminatorValue,
      )
    },
    archivedBooks: n => {
      booksCollectionInfo.archivedBooks = n.getCollectionOfObjectValues<BookCollectionItem>(
        createBookCollectionItemFromDiscriminatorValue,
      )
    },
    newBooks: n => {
      booksCollectionInfo.newBooks = n.getCollectionOfObjectValues<BookCollectionItem>(
        createBookCollectionItemFromDiscriminatorValue,
      )
    },
    tlDrBooks: n => {
      booksCollectionInfo.tlDrBooks = n.getCollectionOfObjectValues<BookCollectionItem>(
        createBookCollectionItemFromDiscriminatorValue,
      )
    },
  }
...
export function deserializeIntoPreparedFileUploadResult(
  ...
  return {
    encodedFileName: n => {
      preparedFileUploadResult.encodedFileName = n.getStringValue()
    },
    fileUploadKey: n => {
...
export function serializeAddLastPageBookmarkRequest(
  ...
  if (!addLastPageBookmarkRequest || isSerializingDerivedType) {
    return
  }
 ...
 */
// @ts-ignore
export function serializeBookCollectionItem(
  writer: SerializationWriter,
  bookCollectionItem: Partial<BookCollectionItem> | undefined | null = {},
  isSerializingDerivedType: boolean = false,
): void {
  if (!bookCollectionItem || isSerializingDerivedType) {
    return
  }
...
export function serializeBookInfo(
  ...
  if (!bookInfo || isSerializingDerivedType) {
    return
  }
...
export function serializeBookmarkInfo(
  ...
  if (!bookmarkInfo || isSerializingDerivedType) {
    return
  }
...
export function serializeBooksCollectionInfo(
  ...
  if (!booksCollectionInfo || isSerializingDerivedType) {
    return
  }
  writer.writeCollectionOfObjectValues<BookCollectionItem>(
    'activeBooks',
    booksCollectionInfo.activeBooks,
    serializeBookCollectionItem,
  )
  writer.writeCollectionOfObjectValues<BookCollectionItem>(
    'archivedBooks',
...
export function serializeCreateBookRequest(
  ...
  if (!createBookRequest || isSerializingDerivedType) {
    return
  }
...
export function serializeCreatedBookResult(
  ...
  if (!createdBookResult || isSerializingDerivedType) {
    return
  }
...
export function serializeFileInfo(
  ...
  if (!fileInfo || isSerializingDerivedType) {
    return
  }
...
export function serializePreparedFileUploadResult(
  ...
  if (!preparedFileUploadResult || isSerializingDerivedType) {
    return
  }
...
export function serializePrepareFileUploadRequest(
  ...
  if (!prepareFileUploadRequest || isSerializingDerivedType) {
    return
  }
...
export function serializeRedirectProblemDetails(
  ...
  if (!redirectProblemDetails || isSerializingDerivedType) {
    return
  }
...
export function serializeUpdateBookRequest(
  ...
  if (!updateBookRequest || isSerializingDerivedType) {
    return
  }
...
export function serializeUpdateCurrentPageRequest(
  ...
  if (!updateCurrentPageRequest || isSerializingDerivedType) {
    return
  }
