...
export function createBymseReadClient(requestAdapter: RequestAdapter) {
  ...
  return apiClientProxifier<BymseReadClient>(
    requestAdapter,
    pathParameters,
    BymseReadClientNavigationMetadata,
    undefined,
  )
}
/**
 ...
 */
export const BymseReadClientNavigationMetadata: Record<
  Exclude<keyof BymseReadClient, KeysToExcludeForNavigationMetadata>,
  NavigationMetadata
> = {
  webApi: {
