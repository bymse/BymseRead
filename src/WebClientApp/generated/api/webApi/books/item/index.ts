...
// @ts-ignore
import {
  createBookInfoFromDiscriminatorValue,
 ...
 */
export const WithBookItemRequestBuilderNavigationMetadata: Record<
  Exclude<keyof WithBookItemRequestBuilder, KeysToExcludeForNavigationMetadata>,
  NavigationMetadata
> = {
  bookmarks: {
